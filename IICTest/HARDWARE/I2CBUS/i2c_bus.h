...
#define SCCB_DATA_IN     {GPIOA->CRL &= 0XFFFFF0FF;GPIOA->CRL |= 0X00000800;}
#define SCCB_DATA_OUT    {GPIOA->CRL &= 0XFFFFF0FF;GPIOA->CRL |= 0X00000300;}
...
int IIC_SendString(uint8_t address,uint8_t* buffer,uint8_t lenght);
uint8_t IIC_SeadChar(uint8_t sensor_addr,uint8_t regDat);
#endif
